...
import { updateProfile } from "@/store/features/adminAuthSlice";
...
const AdminEditProfile = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState(adminProfile.profileImage);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.put(
        `${backend_url}/admin/actions/update-profile/${adminProfile._id}`,
        payload
      );

      dispatch(updateProfile(response.data.admin));
