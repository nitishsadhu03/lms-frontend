...
const StudentEditProfile = () => {
  ...
  const [previewUrl, setPreviewUrl] = useState(studentProfile.profileImage);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axiosInstance.put(
        `${backend_url}/admin/actions/student/${studentProfile._id}`,
        payload
      );

      dispatch(updateProfile(response.data.student));
